...
const TeachersTimetablePage = () => {
      ...
      <DashboardLayout role="teachers">
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50/30">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-medium text-lg mb-2">Loading Your Timetable</p>
            <p className="text-gray-400 text-sm">Preparing your weekly schedule...</p>
          </div>
        </div>
      </DashboardLayout>
    );
  ...
  return (
    <DashboardLayout role="teachers">
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-slate-100 p-4 md:p-6">
        {/* Header Section */}
        <div className="mb-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1 flex items-center gap-2">
                    ...
                    Welcome, {teacherName}
                    {teacherEmail && (
                      <span className="text-gray-400 text-sm">({teacherEmail})</span>
                    )}
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-center gap-2">
                  {hasTodaysClasses ? (
                    ...
                    <>
                      ...
                      <span className="text-sm text-gray-500">No classes scheduled today</span>
                    </>
                  )}
                </div>
              </div>
              ...
              {hasTodaysClasses && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {todaysClasses.map((classItem, index) => (
                    <div
                      key={index}
                      className="px-3 py-1.5 bg-white rounded-lg border border-blue-200 text-xs font-medium text-blue-700 flex items-center gap-2"
                    >
          ...
          <div className="mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">{stats.teachingDays}</p>
          ...
          <div className="mb-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-semibold text-gray-800">Filter Schedule</h3>
              </div>
        ...
        {error && (
          <div className="mb-6 bg-red-50 border border-red-200 rounded-2xl p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-red-800">Unable to Load Timetable</p>
            ...
            {dayKeys.map((day) => (
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <span className="px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 border border-blue-200 flex items-center gap-2">
                ...
                <div className="grid gap-3">
                  {groupedByDay[day]
                    ...
                    .map((entry, index) => (
                      <div
                        key={`${entry.id}-${index}`}
                        className="group flex items-center justify-between p-5 border border-gray-100 rounded-2xl bg-gradient-to-r from-white to-gray-50/50 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-50/30 hover:border-blue-200 transition-all duration-200"
                      >
                        ...
                        <div className="text-right">
                          <span className="inline-flex items-center px-4 py-2 rounded-full bg-slate-100 text-slate-800 border border-slate-200 font-semibold text-sm group-hover:bg-blue-100 group-hover:border-blue-300 group-hover:text-blue-700 transition-colors">
