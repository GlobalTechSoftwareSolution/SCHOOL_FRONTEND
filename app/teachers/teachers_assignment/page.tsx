  ...
  const renderStudentsView = () => {
    ...
    switch (viewMode) {
      case 'total':
        ...
        viewDescription = "Students taught by you across all classes";
      ...
      case 'pending':
        ...
        viewDescription = "Students who haven't submitted any assignment";
      ...
      case 'completed':
        ...
        viewDescription = "Students who have submitted assignments";
      ...
      case 'overdue':
        ...
        viewDescription = "Students who submitted assignments after due date";
            ...
            {filteredStudents.map((student) => (
              <div key={student.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {studentSubmissions[student.email] && studentSubmissions[student.email].length > 0 && (
                    <div className="pt-2 border-t border-gray-100">
                      <div className="flex items-center gap-2 text-xs text-gray-500">
                        ...
                        <span>
                          Last submitted: {
                            (() => {
                              try {
                                const dates = studentSubmissions[student.email]
                                  .map(s => new Date(s.submission_date).getTime())
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        Total submissions: {studentSubmissions[student.email].length}
                      </div>
                    </div>
                  )}
                </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {viewMode === 'assignments' ? 'Create and manage assignments for your students' :
                 viewMode === 'total' ? 'Students taught by you across all classes' :
                 viewMode === 'pending' ? 'Students who haven\'t submitted any assignment' :
                 viewMode === 'completed' ? 'Students who have submitted assignments' :
                 'Students who submitted assignments after due date'}
              </p>
            </div>
