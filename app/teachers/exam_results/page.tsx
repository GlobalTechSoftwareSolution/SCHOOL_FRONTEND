...
export default function ExamResultsPage() {
    ...
    try {
      ...
      try {
        ...
        const answersResponse = await axios.get(
          `https://school.globaltechsoftwaresolutions.cloud/api/submit_multiple_mcq/?exam_id=${examId}`
        );
        ...
        try {
          ...
          const transformedAnswers: StudentAnswer[] = submissionsResponse.data.map((sub: any) => ({
            id: sub.id,
            exam_id: examId,
  ...
  // Get unique student emails for easier searching
  const getUniqueStudentEmails = () => {
    const emails = studentAnswers.map(answer => answer.student_email);
