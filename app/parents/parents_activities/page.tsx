...
const ActivitiesPage = () => {
  ...
  const isUpcomingActivity = (activity: any) => {
    ...
    <DashboardLayout role="parents">
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 p-4 xs:p-5 sm:p-6">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 mb-6 xs:mb-7 sm:mb-8">
          ...
          <div 
            className={`bg-gradient-to-br from-white to-blue-50/50 rounded-xl xs:rounded-2xl shadow-sm border p-4 xs:p-5 sm:p-6 relative overflow-hidden group hover:shadow-md transition-all duration-300 cursor-pointer ${
              viewType === "all" 
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className={`p-2 xs:p-3 rounded-lg xs:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300 ${
                viewType === "all" 
          ...
          <div 
            className={`bg-gradient-to-br from-white to-green-50/50 rounded-xl xs:rounded-2xl shadow-sm border p-4 xs:p-5 sm:p-6 relative overflow-hidden group hover:shadow-md transition-all duration-300 cursor-pointer ${
              viewType === "upcoming" 
          ...
          {/* Past Events Card */}
          <div 
            className={`bg-gradient-to-br from-white to-orange-50/50 rounded-xl xs:rounded-2xl shadow-sm border p-4 xs:p-5 sm:p-6 relative overflow-hidden group hover:shadow-md transition-all duration-300 cursor-pointer ${
              viewType === "past" 
