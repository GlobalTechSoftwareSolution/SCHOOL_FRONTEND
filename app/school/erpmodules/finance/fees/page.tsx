  ...
  const features = [
    {
      ...
      image: "/erpmodules/online_fees.jpg",
      className: "object-[20%_20%]", // Focus on top-left area of the image
    },
    {
      ...
      image: "/erpmodules/dashboard.png",
      className: "object-center", // Center the graph/dashboard
    },
    {
      ...
      image: "/erpmodules/receipt_generator.webp",
      className: "object-top", // Focus on top text of the receipt image
    },
    {
      ...
      image: "/erpmodules/Dues_tracking.jpg",
      className: "object-[50%_40%]", // Slightly lower center
    },
    {
      ...
      image: "/erpmodules/multy_payment.jpg",
      className: "object-center", // Center wallet and icons
    },
    {
      ...
      image: "/erpmodules/analitical.jpg",
      className: "object-[50%_60%]", // Focus on lower part of the dashboard
    },
    {
      ...
      image: "/erpmodules/Automate_fee_reminders.webp",
      className: "object-[30%_30%]", // Slight left focus (show phone)
    },
    {
      ...
      image: "/erpmodules/zero_error.webp",
      className: "object-center", // Center “ZERO” text
    },
  ];
...
>
  <motion.img
    src={item.image}
    alt={item.title}
    className={`w-full h-48 rounded-lg border border-gray-100 shadow-sm bg-white ${item.className}`}
    initial={{
      scale: 0.9, // 👈 start slightly zoomed out (fix for “too close” images)
      objectPosition: "center center",
    }}
    whileHover={{
      scale: 1.05, // 👈 gentle zoom-in when hovering
    }}
    transition={{ duration: 0.4 }}
    style={{
      objectFit: "contain", // 👈 ensures entire image fits without being cropped
    }}
  />
</motion.div>
