        ...
        <div className="max-w-7xl mx-auto">
          ...
          {!selectedStudent ? (
            <>
              ...
              <div className="text-center mb-3 xs:mb-4 sm:mb-6 md:mb-8">
                <div className="flex items-center justify-center gap-2 xs:gap-2 sm:gap-3 mb-2 xs:mb-3 sm:mb-4">
                  <div className="p-2 xs:p-2 sm:p-3 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl sm:rounded-2xl shadow-lg">
                    <GraduationCap className="w-5 h-5 xs:w-5 xs:h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                    Student Management
                  </h1>
                </div>
              ...
              <div className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 p-3 xs:p-4 sm:p-5 md:p-6 mb-3 xs:mb-4 sm:mb-5 md:mb-6">
                <div className="flex flex-col lg:flex-row gap-2 xs:gap-3 sm:gap-4 items-stretch lg:items-center justify-between">
                  <div className="flex-1 w-full lg:max-w-md">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 w-full lg:w-auto">
                    <div className="flex flex-wrap gap-2 sm:gap-3">
                      <select
                        ...
                        className="flex-1 sm:flex-none px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white min-w-[140px]"
                      >
              ...
              {loading ? (
                <div className="flex justify-center items-center py-10 xs:py-12 sm:py-16 md:py-20">
                  <div className="text-center">
                    <div className="animate-spin rounded-full h-10 w-10 xs:h-12 xs:w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 border-b-2 border-emerald-500 mx-auto mb-2 xs:mb-3 sm:mb-4"></div>
                    <p className="text-gray-600 text-xs xs:text-sm sm:text-base">Loading student data...</p>
                  </div>
                </div>
              ) : (
                        ...
                        <div className="flex flex-col items-center text-center">
                          <div className="relative mb-3 sm:mb-4">
                            <img
                              ...
                              className="w-16 h-16 sm:w-20 sm:h-20 md:w-20 md:h-20 rounded-xl sm:rounded-2xl border-2 sm:border-4 border-white shadow-lg group-hover:border-emerald-100 transition-colors"
                            />
                          ...
                          <h3 className="text-base sm:text-lg font-bold text-gray-800 group-hover:text-emerald-600 transition-colors line-clamp-1 px-2">
                            {student.fullname}
                          </h3>
                          
                          <p className="text-xs sm:text-sm text-emerald-600 font-semibold mt-1 px-2">
                            {(() => {
                              const classInfo = getClassInfoForStudent(student);
                          ...
                          <p className="text-xs text-gray-500 mt-2 line-clamp-1 px-2">{student.email}</p>
                          ...
                          <div className="mt-3 sm:mt-4 flex gap-1.5 sm:gap-2 flex-wrap justify-center">
                            ...
                            {student.gender && (
                              <span className="bg-purple-50 text-purple-700 text-xs px-2 sm:px-3 py-1 sm:py-1.5 rounded-full font-medium border border-purple-200">
                                {student.gender}
                              </span>
                            )}
                          </div>
              ...
              {!loading && filteredStudents.length === 0 && (
                <div className="text-center py-8 xs:py-10 sm:py-12 md:py-16">
                  <div className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl p-4 xs:p-6 sm:p-8 md:p-12 max-w-md mx-auto shadow-lg border border-gray-200">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-20 md:h-20 bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                      <GraduationCap className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 text-gray-400" />
                    </div>
                    <h3 className="text-gray-700 font-semibold text-base sm:text-lg mb-2">No Students Found</h3>
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm sm:text-base bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-colors"
                    >
                      Clear Filters
                    </button>
                  </div>
            ...
            <div className="space-y-3 xs:space-y-4 sm:space-y-5 md:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 xs:gap-3 sm:gap-4">
                <button
                  onClick={goBack}
                  className="flex items-center gap-1.5 xs:gap-2 sm:gap-3 text-emerald-600 hover:text-emerald-700 font-semibold transition-colors group text-xs xs:text-sm sm:text-base"
                >
              ...
              {/* Student Header */}
              <div className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-600 rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-6 md:p-8 text-white shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center lg:items-start gap-3 xs:gap-4 sm:gap-5 md:gap-6">
                  ...
                  <div className="flex-1 text-center lg:text-left w-full min-w-0">
                    <h1 className="text-lg xs:text-xl sm:text-2xl md:text-3xl font-bold mb-1 xs:mb-2 truncate">{selectedStudent.fullname}</h1>
                    <p className="text-emerald-100 text-xs xs:text-sm sm:text-base md:text-lg mb-2 xs:mb-3 sm:mb-4 font-medium">
                    ...
                    <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-2 xs:gap-3 sm:gap-4 text-xs sm:text-sm">
                      ...
                      <div className="flex items-center gap-1.5 xs:gap-2 justify-center lg:justify-start min-w-0">
                        <Mail className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 text-emerald-200 flex-shrink-0" />
                      ...
                      <div className="flex items-center gap-1.5 xs:gap-2 justify-center lg:justify-start">
                        <Phone className="w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 text-emerald-200 flex-shrink-0" />
              ...
              {/* Stats Cards */}
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 xs:gap-3 sm:gap-4">
                <div className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-5 md:p-6 shadow-lg border border-gray-200 text-center group hover:shadow-xl transition-all">
                  <div className="w-9 h-9 xs:w-10 xs:h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-emerald-50 rounded-lg xs:rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-1.5 xs:mb-2 sm:mb-3 group-hover:scale-110 transition-transform">
                    <TrendingUp className="w-4 h-4 xs:w-5 xs:h-5 sm:w-5.5 sm:h-5.5 md:w-6 md:h-6 text-emerald-600" />
                  </div>
                  <div className="text-lg xs:text-xl sm:text-2xl font-bold text-emerald-600">{stats.attendancePercentage}%</div>
                  <div className="text-xs sm:text-sm text-gray-600 font-medium">Attendance Rate</div>
                </div>
                ...
                <div className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-5 md:p-6 shadow-lg border border-gray-200 text-center group hover:shadow-xl transition-all">
                  <div className="w-9 h-9 xs:w-10 xs:h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-blue-50 rounded-lg xs:rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-1.5 xs:mb-2 sm:mb-3 group-hover:scale-110 transition-transform">
                    <BookOpen className="w-4 h-4 xs:w-5 xs:h-5 sm:w-5.5 sm:h-5.5 md:w-6 md:h-6 text-blue-600" />
                  </div>
                  <div className="text-lg xs:text-xl sm:text-2xl font-bold text-blue-600">{stats.totalSubjects}</div>
                ...
                <div className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-5 md:p-6 shadow-lg border border-gray-200 text-center group hover:shadow-xl transition-all">
                  <div className="w-9 h-9 xs:w-10 xs:h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-purple-50 rounded-lg xs:rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-1.5 xs:mb-2 sm:mb-3 group-hover:scale-110 transition-transform">
                    <Award className="w-4 h-4 xs:w-5 xs:h-5 sm:w-5.5 sm:h-5.5 md:w-6 md:h-6 text-purple-600" />
                  </div>
                  <div className="text-lg xs:text-xl sm:text-2xl font-bold text-purple-600">{stats.averageGrade}</div>
                  <div className="text-xs sm:text-sm text-gray-600 font-medium">Avg Grade</div>
                </div>
                ...
                <div className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-5 md:p-6 shadow-lg border border-gray-200 text-center group hover:shadow-xl transition-all">
                  ...
                  <div className="text-xs sm:text-sm text-gray-600 font-medium">Approved Leaves</div>
                </div>
              </div>
                  ...
                  <nav className="flex overflow-x-auto scrollbar-hide">
                    {["overview", "attendance", "leaves", "grades", "analytics"].map((tab) => (
                      <button
                        ...
                        className={`flex items-center gap-1.5 sm:gap-2 px-4 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4 font-medium text-xs sm:text-sm transition-all whitespace-nowrap border-b-2 flex-shrink-0 ${
                          activeTab === tab
                      ...
                      >
                        {tab === "overview" && <User className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                        {tab === "attendance" && <Calendar className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                        {tab === "leaves" && <Clock className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                        {tab === "grades" && <Award className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                        {tab === "analytics" && <BarChart3 className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                ...
                <div className="p-4 sm:p-5 md:p-6">
                  ...
                  {activeTab === "overview" && (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          {[
                            ...
                            <div key={index} className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 border-b border-gray-100 last:border-b-0 gap-1 sm:gap-0">
                              ...
                              <span className="font-semibold text-gray-800 text-sm sm:text-base break-words">{item.value}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 bg-white rounded-lg sm:rounded-xl border border-gray-200">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="font-semibold text-sm sm:text-base break-words">{selectedStudent.email || "N/A"}</div>
                            </div>
                          </div>
                          <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 bg-white rounded-lg sm:rounded-xl border border-gray-200">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="font-semibold text-sm sm:text-base">{selectedStudent.phone}</div>
                            </div>
                          </div>
                          <div className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 bg-white rounded-lg sm:rounded-xl border border-gray-200">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="font-semibold text-sm sm:text-base break-words">{selectedStudent.residential_address || "N/A"}</div>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Quick Stats */}
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm lg:col-span-2">
                        <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4 flex items-center gap-2 sm:gap-3">
                  ...
                  {activeTab === "attendance" && (
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm">
                      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4 sm:mb-5 md:mb-6 gap-3 sm:gap-4">
                        ...
                        <div className="flex gap-2 w-full lg:w-auto">
                          <select
                            ...
                            className="px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white flex-1 lg:flex-none"
                          >
                                ...
                                <thead className="bg-gray-50 border-b border-gray-200">
                                  <tr>
                                    {["Date", "Day", "Status", "Check-in Time"].map((header) => (
                                      <th
                                        key={header}
                                        className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider"
                                      >
                                        {header}
                                      </th>
                                    ))}
                  ...
                  {activeTab === "leaves" && (
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm">
                      <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-5 md:mb-6 flex items-center gap-2 sm:gap-3">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                  {leaves.map((leave, index) => (
                                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                                      ...
                                      <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-600 max-w-xs">
                        ...
                        <div className="space-y-4 sm:space-y-5 md:space-y-6">
                                  ...
                                  <tbody className="bg-white divide-y divide-gray-200">
                                    {grades.map((grade, index) => (
                                      <tr key={index} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 whitespace-nowrap">
                                          <span className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 border border-blue-200">
                                            {grade.marks_obtained}
                                          </span>
                                        </td>
                                        <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-600">
                                          <div className="break-words">{grade.remarks || (
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                            <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm">
                              <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4">Performance Summary</h4>
                          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                                {[
                                  ...
                                  <div key={index} className={`p-2.5 sm:p-3 rounded-lg sm:rounded-xl ${stat.bg} text-center group hover:scale-105 transition-transform`}>
                            ...
                            <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm">
                              <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4">Grade Distribution</h4>
                  ...
                  {activeTab === "analytics" && (
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                        ...
                        <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm">
                          <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4">Attendance Overview</h4>
                        ...
                        {/* Academic Analytics */}
                        <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm">
                          <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4">Academic Summary</h4>
                          <div className="space-y-4">
                            <div className="flex justify-between items-center">
...
>
  {parseFloat(String(stats.averageGrade)) >= 3.5
    ...
    : "Needs Improvement"}
                        ...
                        {/* Leave Analytics */}
                        <div className="bg-white rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200 shadow-sm lg:col-span-2">
                          <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4">Leave Statistics</h4>
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                            <div className="text-center p-3 sm:p-4 bg-emerald-50 rounded-lg sm:rounded-xl">
                              <div className="text-xl sm:text-2xl font-bold text-emerald-600">{stats.approvedLeaves}</div>
