  ...
  const Inventory = () => {
    ...
    // 🔥 Updated Features with beautiful working image links
    const features = [
      {
      ...
      },
      {
        ...
        image: "/erpmodules/stock_manage.avif",
      },
      {
        ...
        image: "/erpmodules/theft_preventio.png",
      },
      {
        ...
        image: "/erpmodules/realtime_update.png",
      },
      {
        ...
        image: "/erpmodules/report_card.png",
      },
      {
        ...
        image: "/erpmodules/alerts_notifications.png",
      },
      {
      ...
      },
      {
        ...
        image: "/erpmodules/mobile_access.avif",
      },
    ];
            ...
            {features.map((item, i) => (
              ...
              >
                <div className="overflow-hidden rounded-xl mb-4">
                  <motion.div className="relative overflow-hidden rounded-xl mb-4 bg-white flex items-center justify-center h-48">
  <motion.img
    src={item.image}
    alt={item.title}
    className={`rounded-lg border border-gray-100 shadow-sm w-full h-full transition-transform duration-500 ease-in-out ${
      item.title === "Stock Management"
        ? "object-contain scale-90"
        : item.title === "Theft Prevention"
        ? "object-[40%_50%] scale-95"
        : item.title === "Automated Reports"
        ? "object-[50%_45%] scale-95"
        : item.title === "Real-time Updates"
        ? "object-[50%_55%] scale-95"
        : item.title === "Alerts & Notifications"
        ? "object-[50%_45%] scale-95"
        : "object-contain scale-90"
    }`}
