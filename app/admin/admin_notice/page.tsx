      ...
      <DashboardLayout role="admin">
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50/20 to-purple-50/10">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-medium text-lg">Loading notices...</p>
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="bg-gradient-to-br from-white to-emerald-50/50 rounded-2xl shadow-sm border border-emerald-200/30 p-6 relative overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">My Notices</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.myNotices}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-white to-purple-50/50 rounded-2xl shadow-sm border border-purple-200/30 p-6 relative overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">For Me</p>
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.forMe}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-white to-amber-50/50 rounded-2xl shadow-sm border border-amber-200/30 p-6 relative overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 mt-2">{stats.important}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-white to-green-50/50 rounded-2xl shadow-sm border border-green-200/30 p-6 relative overflow-hidden group hover:shadow-md transition-all duration-300">
              <div className="absolute top-0 right-0 w-20 h-20 bg-green-500/5 rounded-full -translate-y-8 translate-x-8"></div>
              <div className="flex items-center justify-between">
                <div>
              ...
              <div className="flex flex-wrap gap-3 w-full lg:w-auto">
                <div className="flex gap-2 bg-gray-100 p-1 rounded-xl">
                  {[
                    ...
                    { id: 'my', label: 'My Notices', icon: User },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Notices Given By Me */}
            <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl shadow-sm border border-blue-200/30 p-6">
            ...
            {/* Notices For Me */}
            <div className="bg-gradient-to-br from-white to-purple-50/30 rounded-2xl shadow-sm border border-purple-200/30 p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-3">
                ...
                <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 flex justify-between items-center rounded-t-3xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">Share important information with the community</p>
                    </div>
                  </div>
                  <button
                ...
                <form onSubmit={handleCreateNotice} className="p-6 space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300/60 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-white/50 transition-all duration-300"
                  ...
                  <div className="flex items-center gap-3 p-4 bg-amber-50 rounded-xl border border-amber-200">
                    <input
                      ...
                      className="w-5 h-5 text-amber-600 focus:ring-amber-500 border-amber-300 rounded"
                    />
                    <div>
                  ...
                  <div className="flex gap-3 pt-4 border-t border-gray-200/60">
                    <button
                      type="submit"
                      className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl"
                    >
                      📢 Publish Notice
                    </button>
                    <button
                      type="button"
                      onClick={() => setShowCreateForm(false)}
                      className="flex-1 bg-gray-500 text-white px-6 py-3 rounded-xl hover:bg-gray-600 transition-all duration-300 font-semibold"
                    >
                      Cancel
                    </button>
                  </div>
              ...
              <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-gray-200/60">
                <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 flex justify-between items-center rounded-t-3xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">Notice Details</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <p className="text-gray-700 leading-relaxed">{selectedNotice.message}</p>
                  </div>
                  ...
                  {/* Actions */}
                  <div className="flex gap-3 pt-4 border-t border-gray-200/60">
                    <button className="flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors duration-200 font-medium">
                      <Share2 className="h-4 w-4" />
                      Share
                    </button>
                    <button className="flex items-center gap-2 px-4 py-2 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 transition-colors duration-200 font-medium">
...
const NoticeCard = ({ notice, onView, onDelete, getTypeStyles, getTypeIcon, getPriorityBadge, getPriorityIcon }: any) => (
  <div className="bg-white rounded-xl border border-gray-200/60 p-4 hover:shadow-lg transition-all duration-300 group">
    <div className="flex items-start justify-between mb-3">
      <div className="flex-1">
        <div className="flex items-center gap-2 mb-2">
          <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold border ${getTypeStyles(notice.type)}`}>
    ...
    <p className="text-gray-600 text-sm mb-3 line-clamp-2">{notice.message}</p>
      ...
      <div className="flex items-center gap-4">
        ...
        {notice.valid_until && (
          <span className="flex items-center gap-1">
            ...
            Valid until: {notice.valid_until}
          </span>
        )}
      </div>
      <span className="text-gray-400">By: {notice.notice_by || 'System'}</span>
    </div>
  </div>
);
