    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center w-full max-w-6xl mx-4">
        ...
        <div className="lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0 lg:pr-12">
          ...
          <p className="text-xl lg:text-2xl text-gray-700 mb-4 font-light">
            Welcome back to your
          </p>
          <p className="text-2xl lg:text-3xl font-bold text-gray-800 mb-6">
            Learning <span className="text-purple-600">Adventure</span> 🚀
          </p>
        ...
        <div className="relative lg:w-1/2 max-w-md w-full">
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8 lg:p-10 transform hover:scale-[1.02] transition-all duration-300">
            {/* Decorative Elements */}
            <div className="absolute -top-3 -right-3 w-6 h-6 bg-purple-500 rounded-full"></div>
            <div className="absolute -bottom-3 -left-3 w-6 h-6 bg-blue-500 rounded-full"></div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-4 rounded-2xl text-purple-600 border-2 border-purple-600 font-semibold hover:bg-purple-50 transition-all duration-300 transform hover:scale-105"
                >
                  Create Account
                </button>
              </div>
            ...
            <div className="mt-8 text-center">
              <a href="/forgot-password" className="text-sm text-purple-600 hover:text-purple-700 font-medium transition-colors duration-200">
