...
const StudentsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 p-2 sm:p-3 sm:p-4 md:p-5 lg:p-6">
      <div className="max-w-7xl mx-auto">
        {/* Students Grid View */}
        {!selectedStudent ? (
          <>
            {/* Header Section */}
            <div className="text-center mb-4 sm:mb-5 sm:mb-6 md:mb-8">
              <div className="flex flex-col xs:flex-row items-center justify-center gap-2 sm:gap-3 sm:gap-4 mb-2 sm:mb-3">
                <div className="p-2 sm:p-2.5 sm:p-3 md:p-4 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-lg sm:rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg flex-shrink-0">
                  <GraduationCap className="w-4 h-4 sm:w-5 sm:h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 text-white" />
                </div>
                <h1 className="text-lg sm:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent text-center xs:text-left">
                  Student Management
                </h1>
              </div>
              <p className="text-gray-600 text-xs sm:text-sm sm:text-base max-w-2xl mx-auto px-2 sm:px-3 md:px-0">
                Comprehensive student monitoring and management system with advanced analytics
              </p>
            </div>

            {/* Search and Filter Section */}
            <div className="bg-white rounded-lg sm:rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 p-3 sm:p-4 sm:p-5 md:p-6 mb-3 sm:mb-4 sm:mb-5 md:mb-6">
              <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 sm:gap-6 items-stretch lg:items-center justify-between">
                <div className="flex-1 w-full lg:max-w-md">
                  <div className="relative">
                    <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 sm:w-5 sm:h-5 sm:w-5 sm:h-5" />
                    <input
                      type="text"
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 sm:gap-4 w-full lg:w-auto">
                  <div className="flex flex-wrap gap-2 sm:gap-3 sm:gap-4">
                    <div className="relative flex-1 sm:flex-none min-w-[140px] sm:min-w-[160px]">
                      <select
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white appearance-none"
                      >
                  ...
                  <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 px-1 self-center">
            ...
            {/* Students Grid */}
            {loading ? (
              <div className="flex justify-center items-center py-12 sm:py-16 sm:py-20 md:py-24">
                <div className="text-center">
                  <div className="animate-spin rounded-full h-10 w-10 sm:h-12 sm:w-12 sm:h-16 sm:w-16 border-b-2 border-emerald-500 mx-auto mb-3 sm:mb-4"></div>
                  <p className="text-gray-600 text-sm sm:text-base">Loading student data...</p>
                </div>
              </div>
            ) : (
              <>
                  ...
                  {filteredStudents.map((student, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="p-3 sm:p-4 sm:p-5 relative z-10">
                          <div className="flex flex-col items-center text-center">
                            <div className="relative mb-3 sm:mb-4">
                              <Image
                                ...
                                width={80}
                                height={80}
                                className="rounded-lg sm:rounded-xl border-2 sm:border-3 border-white shadow-md sm:shadow-lg group-hover:border-emerald-100 transition-colors mx-auto"
                                onError={(e) => {
                            ...
                            <p className="text-xs sm:text-sm text-emerald-600 font-semibold mb-1.5 sm:mb-2">
                              {classInfo ? (
                                <>
                            ...
                            <p className="text-xs text-gray-500 mb-3 sm:mb-4 line-clamp-1">{student.email || "No email"}</p>

                            <div className="flex gap-1 sm:gap-2 flex-wrap justify-center">
                              <span className="bg-blue-50 text-blue-700 text-[10px] sm:text-xs px-2 py-1 rounded-full font-medium border border-blue-200">
                                ID: {student.student_id || "N/A"}
                              </span>
                              {student.gender && (
                                <span className="bg-purple-50 text-purple-700 text-[10px] sm:text-xs px-2 py-1 rounded-full font-medium border border-purple-200">
                                  {student.gender}
                                </span>
                              )}
                            </div>
                ...
                {!loading && filteredStudents.length === 0 && (
                  <div className="text-center py-10 sm:py-12 sm:py-16 md:py-20">
                    <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 sm:p-8 md:p-12 max-w-md mx-auto shadow-lg border border-gray-200">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 sm:w-24 sm:h-24 bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <GraduationCap className="w-8 h-8 sm:w-10 sm:h-10 text-gray-400" />
                      </div>
                      <h3 className="text-gray-700 font-semibold text-base sm:text-lg sm:text-xl mb-2">No Students Found</h3>
                      ...
                      <button
                        ...
                        className="px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base bg-emerald-500 text-white rounded-lg sm:rounded-xl hover:bg-emerald-600 transition-colors"
                      >
                        Clear All Filters
                      </button>
                    </div>
          ...
          <div className="space-y-3 sm:space-y-4 sm:space-y-5 md:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              ...
              <div className="flex gap-2 w-full sm:w-auto mt-2 sm:mt-0">
                <button
                  ...
                  className="flex items-center gap-2 px-3 sm:px-4 py-2 text-sm bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors shadow-sm w-full sm:w-auto justify-center"
            ...
            {/* Student Header Card */}
            <div className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-600 rounded-lg sm:rounded-xl p-3 sm:p-4 sm:p-5 text-white shadow-lg sm:shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5 w-full">
                <div className="relative flex-shrink-0">
                  <Image
                    ...
                    width={96}
                    height={96}
                    className="rounded-lg sm:rounded-xl border-2 sm:border-3 border-white/80 shadow-lg mx-auto"
                    onError={(e) => {
                      const target = e.target as HTMLImageElement;
                      target.src = "https://i.pravatar.cc/150?img=9";
                    }}
                  />
                  <div className="absolute -bottom-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-green-400 border-2 border-white rounded-full shadow-lg"></div>
                </div>

                <div className="flex-1 text-center sm:text-left w-full min-w-0 mt-2 sm:mt-0">
                  <h1 className="text-lg sm:text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3 break-words w-full">
                    {selectedStudent.fullname || "Unknown Student"}
                  </h1>
                  <p className="text-emerald-100 text-xs sm:text-sm sm:text-base mb-2 sm:mb-3 font-medium">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-cols-3 gap-1.5 sm:gap-2 sm:gap-2.5 text-xs sm:text-sm">
                    <div className="flex items-center gap-1 justify-center sm:justify-start min-w-0">
                    ...
                    <div className="flex items-center gap-1 justify-center sm:justify-start min-w-0">
                      <Mail className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-200 flex-shrink-0" />
                      <span className="break-all truncate text-xs">{selectedStudent.email || "No email"}</span>
                    </div>
                    <div className="flex items-center gap-1 justify-center sm:justify-start">
                      <Phone className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-200 flex-shrink-0" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
              {[
                ...
                <div key={index} className="bg-white rounded-lg p-3 sm:p-4 shadow-md border border-gray-200 text-center group hover:shadow-lg transition-all">
                  <div className={`w-7 h-7 sm:w-8 sm:h-8 sm:w-9 sm:h-9 ${stat.iconBg} rounded-md sm:rounded-lg flex items-center justify-center mx-auto mb-1.5 sm:mb-2 group-hover:scale-110 transition-transform`}>
                    <stat.icon className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div className={`text-xs sm:text-sm font-bold ${stat.color}`}>{stat.value}</div>
                  <div className="text-[10px] sm:text-xs text-gray-600 font-medium mt-0.5">{stat.label}</div>
                </div>
              ))}
            </div>
            ...
            <div className="bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-gray-200 overflow-hidden">
                ...
                <nav className="flex overflow-x-auto scrollbar-hide">
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 px-2 py-2 sm:px-2.5 sm:py-2.5 sm:px-3 sm:py-3 font-medium text-xs sm:text-sm transition-all whitespace-nowrap border-b-2 flex-shrink-0 ${activeTab === tab.id
              ...
              <div className="p-2.5 sm:p-3 sm:p-4 md:p-5">
                {/* ✅ Overview Tab */}
                {activeTab === "overview" && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-4">
                    {/* Personal Information Card */}
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 sm:p-4 sm:p-5 border border-gray-200 shadow-sm">
                      <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-3 flex items-center gap-2">
                        <div className="p-2 bg-emerald-100 rounded-lg">
                          <User className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-600" />
                        </div>
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        {[
                          ...
                          <div key={index} className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-2 border-b border-gray-100 last:border-b-0 gap-1">
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 sm:p-4 sm:p-5 border border-gray-200 shadow-sm">
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        <div className="flex items-center gap-2 p-2 sm:p-3 bg-white rounded-lg border border-gray-200">
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-md sm:rounded-lg p-2.5 sm:p-3 sm:p-4 border border-gray-200 shadow-sm col-span-1 sm:col-span-2">
                      <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-3 flex items-center gap-2">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-2 sm:gap-2.5">
                        {[
                          ...
                          <div key={index} className={`p-2 sm:p-3 rounded-lg ${stat.bg} text-center group hover:scale-105 transition-transform`}>
                ...
                {activeTab === "attendance" && (
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 sm:p-4 sm:p-5 border border-gray-200 shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-2">
                      <h3 className="text-sm sm:text-base font-bold text-gray-800 flex items-center gap-1.5 sm:gap-2">
                        <div className="p-2 bg-emerald-100 rounded-lg">
                      ...
                      <div className="flex gap-2 w-full sm:w-auto">
                        <select
                          ...
                          className="px-2 py-1.5 sm:px-2.5 sm:py-2 text-xs border border-gray-300 rounded-md sm:rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-white w-full sm:w-auto"
                        >
                    ...
                    {loading ? (
                          ...
                          .map((record, index) => (
                            <div key={index} className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm hover:shadow-md transition-all">
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <span className={`inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-semibold ${record.status === "Present"
                      ...
                      <div className="text-center py-4 sm:py-6">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                        ...
                        {leaves.map((leave, index) => (
                          <div key={index} className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm hover:shadow-md transition-all">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <span className={`inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-semibold ${leave.status === "Approved"
                                ? "bg-green-100 text-green-800 border border-green-200"
                                ...
                                {leave.status === "Pending" && <Clock4 className="w-2.5 h-2.5 sm:w-3 sm:h-3 mr-0.5" />}
                                {leave.status === "Rejected" && <XCircle className="w-3 h-3 mr-1" />}
                                {leave.status}
                              </span>
                            </div>
                            <div className="space-y-1 text-xs text-gray-600 mb-1.5 sm:mb-2">
                              <div className="flex justify-between">
                                <span>From:</span>
                ...
                {activeTab === "grades" && (
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 sm:p-4 sm:p-5 border border-gray-200 shadow-sm">
                    <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-3 flex items-center gap-2">
                      <div className="p-2 bg-purple-100 rounded-lg">
                        <Award className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-purple-600" />
                      </div>
                    ...
                    {loading ? (
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                          <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200 shadow-sm">
                            <h4 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-2.5">Performance Summary</h4>
                          ...
                          <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200 shadow-sm">
                            <h4 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-2.5">Grade Distribution</h4>
                      ...
                      <div className="text-center py-6 sm:py-8">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                          <Award className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400" />
                        </div>
                        <h4 className="text-gray-700 font-semibold text-xs sm:text-sm mb-1">No Grade Records</h4>
                ...
                {activeTab === "analytics" && (
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 sm:p-4 sm:p-5 border border-gray-200 shadow-sm">
                    <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-3 flex items-center gap-2">
                      <div className="p-1.5 sm:p-2 bg-indigo-100 rounded-md sm:rounded-lg">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200 shadow-sm">
                        <h4 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-2.5">Attendance Overview</h4>
                        <div className="space-y-2">
                      ...
                      <div className="bg-white rounded-lg p-3 sm:p-4 border border-gray-200 shadow-sm">
                        <h4 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-2.5">Academic Summary</h4>
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span
                              className={`font-semibold text-xs ${parseFloat(stats.averageGrade) >= 3.5
                                ? "text-emerald-600"
                      ...
                      <div className="bg-white rounded-md sm:rounded-lg p-2.5 sm:p-3 sm:p-4 border border-gray-200 shadow-sm sm:col-span-2">
                        <h4 className="text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-2.5">Leave Statistics</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-1.5 sm:gap-2">
                          <div className="text-center p-2 sm:p-2.5 bg-emerald-50 rounded-md sm:rounded-lg">
                            <div className="text-xs sm:text-sm font-bold text-emerald-600">{stats.approvedLeaves}</div>
                            <div className="text-xs text-gray-600">Approved</div>
                          </div>
                          <div className="text-center p-2 sm:p-2.5 bg-yellow-50 rounded-md sm:rounded-lg">
                            <div className="text-base sm:text-lg font-bold text-yellow-600">{stats.pendingLeaves}</div>
                            <div className="text-xs text-gray-600">Pending</div>
                          </div>
                          <div className="text-center p-2 sm:p-2.5 bg-blue-50 rounded-md sm:rounded-lg">
