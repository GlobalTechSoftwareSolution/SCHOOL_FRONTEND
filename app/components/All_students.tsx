  ...
  const fetchStudentDetails = async (student: any) => {
    ...
    try {
      ...
      const studentLeaves = (leavesRes.data || []).filter(
        (l: any) => l.applicant_email?.toLowerCase() === student.email?.toLowerCase()
      );
                          ...
                          <div className="flex flex-col items-center text-center">
                            <div className="relative mb-3 xs:mb-4">
                              <img
                                ...
                                className="w-12 h-12 xs:w-14 xs:h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-lg xs:rounded-xl border-2 xs:border-3 border-white shadow-md sm:shadow-lg group-hover:border-emerald-100 transition-colors mx-auto"
                                onError={(e) => {
              ...
              <div className="relative z-10 flex flex-col xs:flex-row items-center xs:items-start gap-4 xs:gap-5">
                <div className="relative flex-shrink-0">
                  <img
                    ...
                    className="w-14 h-14 xs:w-16 xs:h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-lg xs:rounded-xl border-2 xs:border-3 border-white/80 shadow-lg mx-auto"
                    onError={(e) => {
                      const target = e.target as HTMLImageElement;
