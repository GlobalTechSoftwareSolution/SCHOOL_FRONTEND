        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-gray-200">
              <div className="flex flex-col lg:flex-row gap-4 justify-between items-center">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2 whitespace-nowrap"
                >
              ...
              <div className="bg-white rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-200">
                ...
                <form onSubmit={handleAddActivity} className="space-y-6">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      type="submit"
                      className="flex-1 bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white py-3 px-6 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-200"
                    >
                      Create Activity
                    </button>
                  </div>
                        ...
                        <div className="flex justify-between items-start mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getActivityTypeColor(activity.type)}`}>
                ...
                <div className="text-center py-16">
                  <div className="bg-white rounded-2xl p-12 max-w-md mx-auto shadow-lg">
                    ...
                    {searchTerm || filterType !== "all" ? (
                      ...
                      <button
                        onClick={() => setShowAddForm(true)}
                        className="bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white px-6 py-2 rounded-xl transition-all duration-200"
                      >
          ...
          {selectedActivity && (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
              {/* Header */}
              <div className="bg-gradient-to-r from-purple-500 to-blue-600 rounded-t-2xl p-8 text-white">
                <button
                ...
                <div className="flex flex-col lg:flex-row gap-6 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border ${getActivityTypeColor(selectedActivity.type)} bg-white/20 backdrop-blur-sm`}>
                      ...
                      <div className="space-y-4">
                        ...
                        {selectedActivity.class_name && (
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-sm text-gray-500">Assigned Class</div>
                              <div className="font-semibold">
