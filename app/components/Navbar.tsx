...
const Navbar = () => {
  ...
  const navItems = [
    { name: "Home", href: "/" },
    {
      ...
      href: "/features",
      dropdown: [
        { name: "Academic Management", icon: BookOpen, href: "/features/academics" },
        { name: "Student Portal", icon: GraduationCap, href: "/features/students" },
        { name: "Faculty Hub", icon: Users, href: "/features/faculty" },
        { name: "Admin Dashboard", icon: Settings, href: "/features/admin" },
      ],
    },
